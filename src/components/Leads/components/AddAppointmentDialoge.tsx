  ...
  return (
    ...
    <>
      ...
      <div className="px-4 py-0 relative flex justify-center text-[0.8rem] pt-12">
        <div
          className=" p-2 w-fit h-fit mx-5 rounded-md cursor-pointer hover:bg-slate-200 bg-[#fff] boxShadow"
          onClick={goToLeadsDetails}
        >
          Back
        </div>
        <div className="flex justify-center w-[50vw] border rounded-md bg-[#fff] boxShadow">
