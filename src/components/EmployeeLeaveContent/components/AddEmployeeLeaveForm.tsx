...
const AddEmployeeLeaveForm: React.FC = () => {
  ...
  return (
    <>
    <div className="my-3 text-[0.9rem] bg-[#fff] hover:bg-gray-300 h-fit px-2 py-1 cursor-pointer hidden text-center sm:block w-fit boxShadow border-0  mt-5">
    <Link href={`/employeeLeaveManagement`} >Back</Link>
  </div>
    <ScrollArea className=" w-[100%] xl:w-[56vw]  p-7 my-5 boxShadow bg-[#fff] label-text  border-0  slide-in">
