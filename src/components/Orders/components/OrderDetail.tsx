  ...
  return (
    <div className="px-4 py-0  relative text-[0.8rem]">
      ...
      <div className="flex gap-5  justify-center mt-2">
        <div className="my-3 text-[0.8rem] hover:bg-gray-300 h-fit px-2 py-1 border-0 rounded-lg cursor-pointer hidden text-center sm:block w-fit bg-[#fff] boxShadow">
