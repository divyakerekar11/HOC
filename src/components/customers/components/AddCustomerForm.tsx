...
const AddCustomerForm: React.FC = () => {
  ...
  return (
    <>
         <div className="my-3 mt-5 text-[0.9rem] bg-[#fff] hover:bg-gray-300 h-fit px-2 py-1 cursor-pointer hidden text-center sm:block w-fit boxShadow border-0 " >
          <Link
            href={`/customers`}
    ...
    <ScrollArea className=" p-7 w-full lg:w-[70%]  border-0  my-5 h-[90vh] bg-[#fff] boxShadow slide-in">
            ...
            <div className="mb-3 w-full">
              ...
              <div className="relative">
                <AsyncPaginate
                  ...
                  value={
                    formik.values.selectedUserId
                      ? userOptions
                          .filter(
                            (user: { _id: any }) =>
                              user._id === formik.values.selectedUserId
                          )
                          .map((user: any) => ({
                            value: user._id,
                            label: user.fullName,
                ...
                {/* Formik error handling for selectedUserId */}
