  ...
  return (
    <div className="px-4 py-0 relative">
      ...
      <div className=" flex gap-5 justify-center">
        <div className="my-3 text-[0.8rem] bg-[#fff] hover:bg-gray-300 h-fit w-fit px-2 py-1  cursor-pointer hidden text-center sm:block boxShadow border-0">
          ...
          >
            ...
            <div className="my-6 ">
              <Button
                type="submit"
                // value="Sign In"
                className="lg:w-[6vw] w-full cursor-pointer border-0  px-4 py-1 h-9 text-white transition hover:bg-opacity-90 text-md bg-[#013642] "
              >
                {isCustomerValid ? (
