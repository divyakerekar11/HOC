...
const UpdateWebsiteContent = ({ websiteContentId }: any) => {
  const { websiteContentUpdateData, fetchWebsiteContentUpdateData }: any =
    useEditorStore();
  ...
  return (
    <>
      {Array.isArray(websiteContentUpdateData) &&
        websiteContentId &&
        websiteContentUpdateData.map((editor: any, index: number) => (
