...
//   // Memoize the toggler function to avoid unnecessary re-renders
...
//   // Memoize `setClickedTitleName` function
//   const ClickedTitleName = useCallback((label: string) => {
...
//           className={`h-full ${
//             toggleSider ? "px-3" : ""
//           }  pb-4  overflow-scroll bg-[#29354f] dark:bg-gray-800 text-[#fffff5]`}
//         >
//           {/* Logo Section  */}
//           <div
//             className={`logo_wrapper flex items-center h-12 border-b border-gray-500 ${
...
//               setOpen={setOpen}
//               // setClickedTitleName={setClickedTitleName}
//               setClickedTitleName={ClickedTitleName}
//             />
//             {/* Users Section  */}
//             {userRole !== "admin" ? null : (
//               <MenuItem
