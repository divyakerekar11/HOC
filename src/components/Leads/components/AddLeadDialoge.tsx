    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogTrigger>
        <Button
          ...
          variant="outline"
          className="text-[0.9rem] text-white bg-gradient-to-t from-[#013642] to-[#006f6c] hover:bg-gradient-to-r hover:from-[#fff] hover:to-[#fff]hover:text-[#013642] hover:text-[#013642] "
        >
          New Lead
        </Button>
      </DialogTrigger>
