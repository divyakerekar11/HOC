      ...
      <div className="md:flex justify-center sm:justify-end my-2">
        ...
        <div className="flex justify-normal lg:justify-end">
          <Link href={"/copywriter/addCopywriter"}>
            <Button
              variant="outline"
              className=" text-[0.9rem] text-white bg-gradient-to-t from-[#013642] to-[#006f6c] hover:bg-gradient-to-r hover:from-[#fff] hover:to-[#fff]hover:text-[#013642] hover:text-[#013642] boxShadow  border-0 "
            >
