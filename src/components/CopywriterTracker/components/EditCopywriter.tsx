...
const EditCopywriter = () => {
  ...
  const currentYear = dateComplete
    ...
    : getYear(new Date());
  return (
    <div className="p-4 relative text-[0.9rem]">
      <div className="text-[1rem] font-semibold absolute top-[-56px] ">
      ...
      <div className=" flex gap-5 justify-center">
        ...
        <ScrollArea className="h-[80vh]  sm:px-3 sm:py-3 w-[100%] xl:w-[56vw]">
          <form
            ...
            className="border-0  slide-in  p-6 bg-[#fff]"
          >
            ...
            <div className="mb-5 w-full">
              <label className="mb-2.5 block font-medium text-[#29354f] dark:text-white text-[0.9rem]">
                Completed Date
              </label>
              <div className="relative">
                <Popover>
            ...
            <div className="my-6 ">
              <Button
                type="submit"
                className="lg:w-[6vw] cursor-pointerborder-0  p-2 h-9  bg-[#013642] px-4 py-1 text-white transition hover:bg-opacity-90 text-md"
              >
                {isCopywriterValid ? (
